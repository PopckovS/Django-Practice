...
задача по `Backend` разработке, от `Devops` до создания `Django`,
от создания `REST API` до `SQL`, и разное другое с чем я работал.
...
1. **Модели**
      ...
      - **[ №5 Множественные БД ](Models/Models_7.md)**
        - Работа приложения с множеством БД
